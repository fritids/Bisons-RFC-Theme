...
function header_css_and_js($hook) {
    ...
    wp_register_script('dynamicforms', get_template_directory_uri() . '/scripts/dynamicforms.js', null, '1.7.8', true); 
    wp_register_script('formvalidation', get_template_directory_uri() . '/scripts/formvalidation.js', null, '1.3.2', true); 
  ...
  //  wp_register_script( 'image_preloader', get_template_directory_uri() . '/scripts/imagepreloader.php?templatelocation='.urlencode(get_bloginfo('template_url')), null, null );
  //  wp_enqueue_script( 'image_preloader' );
    ...
    // CSS
    wp_register_style('main_css_file', $GLOBALS['blog_info']['template_url'].'/stylesheets/main.css', false, '6.9.1');
