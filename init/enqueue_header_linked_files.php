...
function header_css_and_js($hook) {
    ...
    wp_register_script('formvalidation', get_template_directory_uri() . '/scripts/formvalidation.js', null, '1.4.0', true); 
  ...
  //  wp_enqueue_script( 'image_preloader' );
    ...
    // CSS
    wp_register_style('main_css_file', $GLOBALS['blog_info']['template_url'].'/stylesheets/main.css', false, '7.0.4');
