                     ...
                     ?> 
                            ...
                            <td class="personaldetails">
                                <ul>
                                    ...
                                    <li><strong>Address</strong><br /><?php echo get_post_meta(get_the_id(), 'streetaddy', true) ?><br /><?php echo get_post_meta(get_the_id(), 'postcode', true) ?></li>
                                </ul>
                            </td>
                            <td class="personaldetails">
                                <ul>
                           ...
                           <ul>
                            ...
                            <td class="admin">
                                <ul>
                                <?php 
                                switch (get_post_meta(get_the_id(), 'paymentstatus', true)) : 
                                    case 1: 
                                    ?><li><strong>Type</strong><br />Manual</li><li><strong>Verified</strong><br />No<br /><form method="post" action="/wp-admin/admin.php?page=manage-players&filter=admin"><button name='verify' value="<?php echo get_the_id() ?>">Verify</button></form></li><?php 
                                    break; 
                                    case 2: 
                                    ?><li><strong>Type</strong><br />Manual</li><li><strong>Verified</strong><br />Yes</li><?php
                                    break;             
                                    case 3: 
                                    ?><li><strong>Type</strong><br />Website</li><?php
                                    break;
                                 endswitch; ?>
                                 <li><strong>Membership</strong> <?php
                                   switch (get_post_meta(get_the_id(), 'memtype', true)) : 
                                        ...
                                        break; 
                                        case 40: 
                                        ?><li>£70 - Concession Membership</li><?php
                                        break; 
                                     endswitch; ?>
                                 </li>
                                </ul>
