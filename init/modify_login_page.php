...
function custom_login_message() { $message = "You have tried to reach a page that can only be accessed by a current club member. If you are a club member and don't have an account yet or have forgotten your password, please get in contact with a member of the committee."; return $message; }
