...
<html>
	<head>
		...
		<style type="text/css">
                  ...
                  #mainheader { text-align:left; margin-bottom:3em; }
                  #comingsoon { margin:0.5em; }
                  #comingsoon p { color:white; text-align:center; font-size:1.4em}
                  @media screen and (max-width: 580px) {
                        #showmenu { display:none; }
                        #comingsoon { padding-top: 7em; }
                  }
            </style>
	</head>
	<body>
	...
	<header id="mainheader">
	    <div id="col">
          ...
          <a class="logo" href="<?php echo $GLOBALS['blog_info']['url'] ?>" title="Return to the homepage">
            <img src="<?php echo get_template_directory_uri(); ?>/images/pinkbisonsvg.svg" alt="Bisons Logo" />
	...
	<div id="comingsoon">
            <p>BisonsRFC.co.uk gets a new look! Launching on Saturday the 12th of July 2014...</p>
            </div>
<?php wp_footer() ?>
</body></html>